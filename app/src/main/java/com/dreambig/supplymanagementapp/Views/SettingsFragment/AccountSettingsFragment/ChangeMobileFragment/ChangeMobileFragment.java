package com.dreambig.supplymanagementapp.Views.SettingsFragment.AccountSettingsFragment.ChangeMobileFragment;
...
import com.dreambig.supplymanagementapp.databinding.FragmentChangeMobileBinding;
...
public class ChangeMobileFragment extends Fragment {
    ...
    private FragmentChangeMobileBinding binding;
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        binding = FragmentChangeMobileBinding.inflate(inflater,container, false);
    ...
    private void userLiveData() {
        mViewModel.getmUserInfo().observe(getViewLifecycleOwner(), new Observer<UserModel>() {
            ...
            public void onChanged(UserModel userModel) {
                binding.etNewMobile.setText(userModel.getMobile_number());
            }
        });
    }
